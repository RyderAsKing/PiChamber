...
const SUPPORTED_BINARY_MIMES = new Map<string, PiAttachmentMimeType>([
  ["image/png", "image/png"],
...
const SUPPORTED_BINARY_EXTENSIONS = new Map<string, PiAttachmentMimeType>([
  ["gif", "image/gif"],
  ["jpeg", "image/jpeg"],
  ["jpg", "image/jpeg"],
  ["pdf", "application/pdf"],
...
const OMITTED = "[OMITTED BY PICHAMBER]"
