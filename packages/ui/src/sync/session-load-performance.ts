...
declare global {
  interface Window {
    __pichamberSessionLoadPerformance?: SessionLoadPerformanceState
  }
}
...
export function startSessionLoadPerformanceEvent(input: Omit<SessionLoadPerformanceEvent, "at" | "durationMs" | "outcome">) {
  ...
  return (
    ...
    const state = window.__pichamberSessionLoadPerformance ?? { events: [] }
    ...
    window.__pichamberSessionLoadPerformance = state
  }
}
...
const FIRST_VISIBLE_MARK = "pichamber.chat.first_message_visible"
