...
import { getWorktreeSetupCommands, getWorktreeSetupWaitEnabled } from '@/lib/pichamberConfig';
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      if (shouldCreateSession) {
        ...
        try {
          useSessionUIStore.getState().initializeNewPiChamberSession(session.id, useConfigStore.getState().agents);
        } catch {
          // ignore
        }
      } else {
