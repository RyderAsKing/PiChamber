...
export const PlanView: React.FC<PlanViewProps> = ({ targetPath = null, onNavigatedToChat }) => {
  ...
  const handleConfirmPlanSend = React.useCallback(
    ...
    [canCreateWorktree, createSession, currentProjectRef, initializeNewPiChamberSession, pendingPlanSend, resolvedPath, routeToChat, sendMessage, sendPromptTitle, setCurrentSession]
  );
