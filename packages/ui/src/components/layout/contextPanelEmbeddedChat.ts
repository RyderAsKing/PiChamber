...
export const EMBEDDED_RUNTIME_BOOTSTRAP_REQUEST = 'pichamber:embedded-runtime-bootstrap-request';
export const EMBEDDED_RUNTIME_BOOTSTRAP_RESPONSE = 'pichamber:embedded-runtime-bootstrap-response';
