...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sessionOptions.thinkingLevel.label": "Nivel de pensamiento",
  "sessions.sessionOptions.agent.label": "Agente",
  ...
  "sessions.sidebar.footer.actions.aboutPiChamber": "Acerca de PiChamber",
  ...
  "sessions.sidebar.bulkActions.archiveAllAria": "Archivar todas las sesiones",
  "sessions.sidebar.bulkActions.archiveAll": "Archivar todas",
  "sessions.sidebar.bulkActions.cancel": "Cancelar",
  ...
  "aboutDialog.diagnosticsDescription": "Incluye el estado de PiChamber, el estado de OpenCode, directorios y proyectos.",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Si PiChamber no detecta OpenCode automáticamente, establece la ruta del ejecutable a continuación.",
  "onboarding.localSetup.intro": "OpenCode es el corazón de PiChamber. Instálalo para empezar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Guarda en la configuración de PiChamber y recarga la configuración de OpenCode.",
