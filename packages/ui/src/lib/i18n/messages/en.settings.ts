export const settingsDict = {
  ...
  'settings.pichamber.tunnel.notAvailable.cloudflaredNotFound': 'cloudflared not found',
  ...
  'settings.pichamber.tunnel.field.managedRemoteTokenInfoAria': 'Managed remote tunnel token info',
  ...
  'settings.pichamber.tunnel.tooltip.tokensSavedPath': 'Tokens are saved in ~/.config/openchamber/cloudflare-managed-remote-tunnels.json.',
  ...
  'settings.pichamber.about.title': 'About PiChamber',
  ...
  'settings.pichamber.about.state.unknown': 'unknown',
  'settings.pichamber.about.actions.checkUpdates': 'Check updates',
  'settings.pichamber.about.actions.update': 'Update',
  ...
  'settings.pichamber.opencodeCli.tooltipPrefix': 'Optional absolute path to the',
  'settings.pichamber.opencodeCli.tooltipSuffix': 'binary.',
  'settings.pichamber.opencodeCli.field.binaryPath': 'OpenCode Binary Path',
  'settings.pichamber.opencodeCli.field.binaryPathPlaceholder': '/Users/you/.bun/bin/opencode',
  'settings.pichamber.opencodeCli.field.showUpdateNotifications': 'Show OpenCode update notifications',
  ...
  'settings.pichamber.opencodeCli.actions.restartingOpenCode': 'Restarting OpenCode…',
  'settings.pichamber.opencodeCli.dialog.selectBinaryTitle': 'Select opencode binary',
  'settings.pichamber.opencodeCli.tipPrefix': 'Tip: you can also use',
  'settings.pichamber.opencodeCli.tipMiddle': 'env var, but this setting persists in',
  ...
  'settings.pichamber.keyboardShortcuts.action.open_go_to_line.label': 'Go to line (files editor)',
  'settings.pichamber.keyboardShortcuts.action.open_command_palette.label': 'Open command palette',
  'settings.pichamber.keyboardShortcuts.action.focus_input.label': 'Focus input',
  'settings.pichamber.keyboardShortcuts.action.open_settings.label': 'Open settings',
  'settings.pichamber.keyboardShortcuts.action.toggle_terminal.label': 'Toggle terminal dock',
  'settings.pichamber.keyboardShortcuts.action.toggle_terminal_expanded.label': 'Toggle terminal expanded',
  'settings.pichamber.keyboardShortcuts.action.add_selection_to_chat.label': 'Add selection to chat',
  'settings.pichamber.keyboardShortcuts.action.toggle_sidebar.label': 'Toggle sidebar',
  'settings.pichamber.keyboardShortcuts.action.toggle_right_sidebar.label': 'Toggle context panel',
  'settings.pichamber.keyboardShortcuts.action.open_right_sidebar_git.label': 'Open Git surface',
  'settings.pichamber.keyboardShortcuts.action.open_right_sidebar_files.label': 'Open Files surface',
  'settings.pichamber.keyboardShortcuts.action.switch_context_surface.label': 'Switch context panel surface',
  'settings.pichamber.keyboardShortcuts.action.switch_context_surface.suffix': ' + 1…0',
  'settings.pichamber.keyboardShortcuts.action.new_chat.label': 'New session',
  'settings.pichamber.keyboardShortcuts.action.new_chat_worktree.label': 'New worktree draft',
  'settings.pichamber.keyboardShortcuts.action.new_mini_chat.label': 'New Mini Chat window',
  'settings.pichamber.keyboardShortcuts.action.open_help.label': 'Open keyboard shortcuts',
  'settings.pichamber.keyboardShortcuts.action.toggle_context_plan.label': 'Toggle plan context panel',
  'settings.pichamber.keyboardShortcuts.action.toggle_services_menu.label': 'Toggle services menu',
  'settings.pichamber.keyboardShortcuts.action.cycle_services_tab.label': 'Cycle services tab',
  'settings.pichamber.keyboardShortcuts.action.cycle_theme.label': 'Cycle theme',
  'settings.pichamber.keyboardShortcuts.action.cycle_agent.label': 'Cycle agent',
  'settings.pichamber.keyboardShortcuts.action.cycle_favorite_model_forward.label': 'Cycle favorite model forward',
  'settings.pichamber.keyboardShortcuts.action.cycle_favorite_model_backward.label': 'Cycle favorite model backward',
  'settings.pichamber.keyboardShortcuts.action.open_model_selector.label': 'Open model selector',
  'settings.pichamber.keyboardShortcuts.action.expand_input.label': 'Expand input',
  'settings.pichamber.keyboardShortcuts.action.open_timeline_dialog.label': 'Open conversation timeline',
  'settings.pichamber.keyboardShortcuts.action.toggle_prompt_navigator.label': 'Toggle prompt navigator',
  ...
  'settings.pichamber.worktrees.state.selectProject': 'Select a project to manage worktrees.',
  'settings.pichamber.worktrees.state.gitOnly': 'Worktree settings are only available for Git repositories.',
  'settings.pichamber.worktrees.setup.title': 'Setup commands',
  'settings.pichamber.worktrees.setup.tooltipPrefix': 'Run automatically inside the new worktree directory when a worktree is created. Use',
  'settings.pichamber.worktrees.setup.tooltipSuffix': 'for the project root.',
  'settings.pichamber.worktrees.setup.loading': 'Loading...',
  'settings.pichamber.worktrees.setup.commandPlaceholder': 'e.g., bun install',
  'settings.pichamber.worktrees.setup.removeCommandAria': 'Remove command',
  'settings.pichamber.worktrees.setup.addCommand': 'Add command',
  'settings.pichamber.worktrees.setup.waitForCommands': 'Wait for setup commands before creating or sending a session',
  'settings.pichamber.worktrees.setup.waitForCommandsAria': 'Wait for Worktree setup commands before creating or sending a session',
  'settings.pichamber.worktrees.setup.toast.saveFailed': 'Failed to save worktree setup commands',
  'settings.pichamber.worktrees.list.title': 'Existing worktrees',
  'settings.pichamber.worktrees.list.tooltip': 'Deleting a worktree also removes its linked sessions.',
  'settings.pichamber.worktrees.list.loading': 'Loading worktrees...',
  'settings.pichamber.worktrees.list.empty': 'No worktrees found for this project',
  'settings.pichamber.worktrees.list.detachedHead': 'Detached HEAD',
  'settings.pichamber.worktrees.list.deleteWorktreeAria': 'Delete worktree {name}',
  ...
  'settings.providers.page.custom.field.apiKey.info': 'Stored in OpenCode auth, not by PiChamber. Use {env:VAR_NAME} to read a key from the environment instead.',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to OpenCode and never stored by PiChamber.',
  ...
  'settings.pichamber.defaults.summaryOpenCodeDefault': 'OpenCode agent default',
  ...
  'settings.pichamber.defaults.field.defaultAgent': 'Default Agent',
  ...
  'settings.pichamber.visual.section.spacingAndLayout': 'Spacing & Layout',
  ...
  'settings.pichamber.visual.section.sessionAssistance': 'Session Assistance',
  ...
  'settings.pichamber.visual.actions.saveAndRestart': 'Save & restart',
  'settings.pichamber.visual.actions.restarting': 'Restarting…',
  'settings.pichamber.visual.field.themeImportInfoAria': 'Theme import info',
  'settings.pichamber.visual.field.themeImportInfoTooltip': 'Import custom themes from ~/.config/openchamber/themes/',
  ...
  'settings.pichamber.visual.field.sessionRecap': 'Generate Session Recap',
  'settings.pichamber.visual.field.sessionRecapAria': 'Generate a recap after the agent finishes',
  'settings.pichamber.visual.field.sessionSuggestion': 'Generate Next User Message Suggestion',
  'settings.pichamber.visual.field.sessionSuggestionAria': 'Generate a suggested next user message after the agent finishes',
  'settings.pichamber.visual.field.sessionGoal': 'Enable Session Goals',
  'settings.pichamber.visual.field.sessionGoalAria': 'Keep the session working toward a goal automatically',
  'settings.pichamber.visual.goal.sectionTitle': 'Goal',
  'settings.pichamber.visual.goal.budgetLabel': 'Default token budget',
  'settings.pichamber.visual.goal.budgetAria': 'Apply a default token budget to new goals',
  'settings.pichamber.visual.goal.description': 'Arm the target button in the composer and the next message becomes a goal: the agent keeps working toward it automatically, audited by the small model, even while you are away.',
  ...
  'settings.pichamber.visual.field.queueMessagesByDefaultAria': 'Queue messages by default',
  'settings.pichamber.visual.field.queueMessagesByDefault': 'Queue Messages by Default',
  'settings.pichamber.visual.field.queueMessagesByDefaultTooltip': 'When enabled, Enter queues messages. Use {modifier}+Enter to send.',
