...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sessionOptions.thinkingLevel.label': '思考级别',
  'sessions.sessionOptions.agent.label': '智能体',
  ...
  'sessions.sidebar.footer.actions.aboutPiChamber': '关于 PiChamber',
  ...
  'sessions.sidebar.bulkActions.archiveAllAria': '归档所有会话',
  'sessions.sidebar.bulkActions.archiveAll': '全部归档',
  ...
  'aboutDialog.diagnosticsDescription': '包含 PiChamber 状态、OpenCode 健康信息、目录和项目。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 PiChamber 未自动检测到 OpenCode，请在下方设置可执行文件路径。',
  'onboarding.localSetup.intro': 'OpenCode 是 PiChamber 的核心，先安装它即可开始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '将保存到 PiChamber 设置并重新加载 OpenCode 配置。',
