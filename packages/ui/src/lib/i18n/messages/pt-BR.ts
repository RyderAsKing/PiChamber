...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sessionOptions.thinkingLevel.label": "Nível de raciocínio",
  ...
  "sessions.sidebar.footer.actions.aboutPiChamber": "Sobre o PiChamber",
  ...
  "sessions.sidebar.bulkActions.archiveAllAria": "Arquivar todas as sessões",
  "sessions.sidebar.bulkActions.archiveAll": "Arquivar todas",
  ...
  "aboutDialog.diagnosticsDescription": "Inclui o estado do PiChamber, a integridade do OpenCode, diretórios e projetos.",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Se o PiChamber não detectar o OpenCode automaticamente, defina o caminho do executável a seguir.",
  "onboarding.localSetup.intro": "OpenCode é o coração do PiChamber. Instale-o para começar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Salve nas configurações do PiChamber e recarregue configurações do OpenCode.",
