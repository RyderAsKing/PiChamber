...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sessionOptions.thinkingLevel.label": "Рівень мислення",
  "sessions.sessionOptions.agent.label": "Агент",
  ...
  "sessions.sidebar.footer.actions.aboutPiChamber": "Про PiChamber",
  ...
  "sessions.sidebar.bulkActions.archiveAllAria": "Архівувати всі сесії",
  "sessions.sidebar.bulkActions.archiveAll": "Архівувати все",
  "sessions.sidebar.bulkActions.cancel": "Скасувати",
  ...
  "aboutDialog.diagnosticsDescription": "Містить стан PiChamber, стан OpenCode, каталоги та проєкти.",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Якщо PiChamber не визначає OpenCode автоматично, укажіть шлях до виконуваного файла нижче.",
  "onboarding.localSetup.intro": "OpenCode — серце PiChamber. Встановіть його, щоб почати.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Зберігає налаштування в PiChamber і перезавантажує конфігурацію OpenCode.",
