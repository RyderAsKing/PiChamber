...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.footer.actions.aboutPiChamber': 'O PiChamber',
  ...
  'sessions.sidebar.bulkActions.archiveAllAria': 'Zarchiwizuj wszystkie sesje',
  'sessions.sidebar.bulkActions.archiveAll': 'Zarchiwizuj wszystkie',
  'sessions.sidebar.bulkActions.cancel': 'Anuluj',
  ...
  'sessions.sessionOptions.thinkingLevel.label': 'Poziom myślenia',
  'sessions.sessionOptions.agent.label': 'Agent',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli PiChamber nie wykryje OpenCode automatycznie, ustaw ścieżkę binarki poniżej.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień PiChamber i przeładowuje konfigurację OpenCode.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan PiChamber, kondycję OpenCode, katalogi i projekty.',
  ...
  'onboarding.localSetup.intro': 'OpenCode to serce PiChamber — zainstaluj je, aby zacząć.',
  ...
  'settings.pichamber.keyboardShortcuts.action.open_timeline_dialog.label': 'Otwórz oś czasu',
  ...
  'settings.pichamber.visual.field.mobileKeyboardModeAria': 'Tryb klawiatury mobilnej',
  'settings.pichamber.visual.field.selectMobileKeyboardModePlaceholder': 'Wybierz tryb klawiatury mobilnej',
  'settings.pichamber.visual.actions.resetMobileKeyboardModeAria': 'Resetuj tryb klawiatury mobilnej',
  'settings.pichamber.visual.option.mobileKeyboardMode.native.label': 'Natywny',
  'settings.pichamber.visual.option.mobileKeyboardMode.native.description': 'Użyj domyślnego zachowania przeglądarki/systemu.',
  'settings.pichamber.visual.option.mobileKeyboardMode.resizeContent.label': 'Zmień rozmiar zawartości',
  'settings.pichamber.visual.option.mobileKeyboardMode.resizeContent.description': 'Dopasuj układ tak, aby zawartość pozostała widoczna ponad klawiaturą.',
