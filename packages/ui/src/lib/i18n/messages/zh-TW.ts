...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sessionOptions.thinkingLevel.label': '思考級別',
  ...
  'sessions.sidebar.footer.actions.aboutPiChamber': '關於 PiChamber',
  ...
  'sessions.sidebar.bulkActions.archiveAllAria': '封存所有工作階段',
  'sessions.sidebar.bulkActions.archiveAll': '全部封存',
  'sessions.sidebar.bulkActions.cancel': '取消',
  ...
  'aboutDialog.diagnosticsDescription': '包含 PiChamber 狀態、OpenCode 健康資訊、目錄和專案。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 PiChamber 未自動偵測到 OpenCode，請在下方設定執行檔路徑。',
  'onboarding.localSetup.intro': 'OpenCode 是 PiChamber 的核心，先安裝它即可開始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '將儲存到 PiChamber 設定並重新載入 OpenCode 設定。',
