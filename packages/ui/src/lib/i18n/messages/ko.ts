...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sessionOptions.thinkingLevel.label': '추론 수준',
  'sessions.sessionOptions.agent.label': '에이전트',
  ...
  'sessions.sidebar.footer.actions.aboutPiChamber': 'PiChamber 정보',
  ...
  'sessions.sidebar.bulkActions.archiveAllAria': '모든 세션 보관',
  'sessions.sidebar.bulkActions.archiveAll': '모두 보관',
  'sessions.sidebar.bulkActions.cancel': '취소',
  ...
  'aboutDialog.diagnosticsDescription': 'PiChamber 상태, OpenCode 상태, 디렉터리 및 프로젝트를 포함합니다.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'PiChamber가 OpenCode를 자동으로 찾지 못하면 아래에 바이너리 경로를 설정하세요.',
  'onboarding.localSetup.intro': 'OpenCode는 PiChamber의 심장입니다. 먼저 설치하고 시작하세요.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'PiChamber 설정에 저장하고 OpenCode 구성을 다시 로드합니다.',
