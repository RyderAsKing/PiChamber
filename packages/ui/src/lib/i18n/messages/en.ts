...
export const dict = {
  ...
  'sessions.sessionOptions.thinkingLevel.label': 'Thinking level',
  ...
  'sessions.sidebar.footer.actions.aboutPiChamber': 'About PiChamber',
  ...
  'sessions.sidebar.bulkActions.archiveAllAria': 'Archive all sessions',
  'sessions.sidebar.bulkActions.archiveAll': 'Archive all',
  'sessions.sidebar.bulkActions.cancel': 'Cancel',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes PiChamber state, OpenCode health, directories, and projects.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If PiChamber does not detect OpenCode automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'OpenCode is the heart of PiChamber — install it to get started.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to PiChamber settings and reloads OpenCode configuration.',
