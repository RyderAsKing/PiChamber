...
const SETTINGS_SEARCH_ITEMS: readonly SettingsSearchItem[] = [
  ...
  },
  {
    ...
    description: "Choose stable desktop releases only or subscribe to desktop release candidates.",
  ...
  },
  {
    ...
    description: "Choose stable server releases only or subscribe this server to release candidates.",
