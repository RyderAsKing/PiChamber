...
const SETTINGS_SEARCH_ITEMS: readonly SettingsSearchItem[] = [
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.pichamber.visual.field.dockBadge',
    descriptionKey: 'settings.pichamber.visual.field.dockBadgeHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.pichamber.visual.field.interfaceFontSize',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.pichamber.visual.field.terminalFontSize',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.pichamber.visual.field.editorFontSize',
    keywords: ['editor', 'font', 'text size', 'code'],
  },
  {
    id: 'appearance.spacing-density',
    page: 'appearance',
    titleKey: 'settings.pichamber.visual.field.spacingDensity',
    keywords: ['density', 'compact', 'comfortable', 'spacing'],
  },
  {
    id: 'appearance.input-bar-offset',
    page: 'appearance',
    titleKey: 'settings.pichamber.visual.field.inputBarOffset',
    descriptionKey: 'settings.pichamber.visual.field.inputBarOffsetTooltip',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.pichamber.visual.field.autoSaveEnabled',
    descriptionKey: 'settings.pichamber.visual.field.autoSaveEnabledInfo',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.pichamber.visual.field.fileEditorKeymap',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.pichamber.visual.field.sendAnonymousUsageReports',
    descriptionKey: 'settings.pichamber.visual.field.sendAnonymousUsageReportsHint',
    keywords: ['telemetry', 'analytics'],
  },
  {
    id: 'chat.render-mode',
    page: 'chat',
    titleKey: 'settings.pichamber.visual.section.chatRenderMode',
    keywords: ['messages', 'conversation', 'rendering'],
  },
  {
    id: 'chat.message-transport',
    page: 'general',
    titleKey: 'settings.pichamber.visual.section.messageStreamTransport',
  ...
  },
  {
    id: 'chat.reasoning',
    page: 'chat',
    titleKey: 'settings.pichamber.visual.section.reasoning',
    keywords: ['thinking', 'traces'],
  },
  {
    id: 'chat.sticky-user-header',
    page: 'chat',
    titleKey: 'settings.pichamber.visual.field.stickyUserHeader',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.pichamber.visual.field.collapsibleUserMessages',
    keywords: ['collapse', 'expand', 'clamp', 'long messages', 'user messages'],
  },
  {
    id: 'chat.wide-layout',
    page: 'chat',
    titleKey: 'settings.pichamber.visual.field.wideChatLayout',
    keywords: ['layout', 'wide', 'messages'],
  },
  {
    id: 'chat.message-appearance',
    page: 'chat',
    titleKey: 'settings.pichamber.visual.section.messageAppearance',
    keywords: ['layout', 'messages', 'appearance'],
  },
  {
    id: 'chat.code-block-line-wrap',
    page: 'chat',
    titleKey: 'settings.pichamber.visual.field.codeBlockLineWrap',
    keywords: ['code', 'wrap', 'line wrap', 'markdown'],
  },
  {
    id: 'chat.inline-assistant-actions',
    page: 'chat',
    titleKey: 'settings.pichamber.visual.field.showSplitAssistantMessageActions',
    descriptionKey: 'settings.pichamber.visual.field.showSplitAssistantMessageActionsTooltip',
    keywords: ['copy', 'save image', 'read aloud'],
  },
  {
    id: 'chat.draft-starters-visible',
    page: 'chat',
    titleKey: 'settings.pichamber.visual.field.draftStartersVisible',
    keywords: ['starter', 'starters', 'new session', 'welcome', 'suggestions'],
  },
  {
    id: 'chat.subagent-read-only-banner',
    page: 'chat',
    titleKey: 'settings.pichamber.visual.field.allowPromptingSubagentSessions',
    keywords: ['subagent', 'read only', 'prompt', 'banner'],
  },
  {
    id: 'chat.tool-file-icons',
    page: 'chat',
    titleKey: 'settings.pichamber.visual.field.showToolFileIcons',
    keywords: ['tools', 'files', 'icons'],
  },
  {
    id: 'chat.tools-and-files',
    page: 'chat',
    titleKey: 'settings.pichamber.visual.section.toolsAndFiles',
    keywords: ['tools', 'files', 'dotfiles'],
  },
  {
    id: 'chat.changed-files',
    page: 'chat',
    titleKey: 'settings.pichamber.visual.field.showTurnChangedFiles',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.pichamber.visual.section.followUpBehavior',
    descriptionKey: 'settings.pichamber.visual.field.followUpBehaviorDescription',
    keywords: ['follow up', 'queue', 'steer', 'send immediately'],
  },
  {
    id: 'chat.persist-drafts',
    page: 'chat',
    titleKey: 'settings.pichamber.visual.field.persistDraftMessages',
    keywords: ['draft', 'message'],
  },
  {
    id: 'chat.composer',
    page: 'chat',
    titleKey: 'settings.pichamber.visual.section.composer',
    keywords: ['input', 'draft', 'spellcheck'],
  },
  {
    id: 'chat.spellcheck',
    page: 'chat',
    titleKey: 'settings.pichamber.visual.field.enableSpellcheckInTextInputs',
  ...
  },
  {
    ...
    page: 'sessions',
    titleKey: 'settings.pichamber.defaults.field.defaultModel',
    keywords: ['model', 'provider', 'new sessions'],
  },
  {
    id: 'sessions.default-thinking',
    page: 'sessions',
    titleKey: 'settings.pichamber.defaults.field.defaultThinking',
    keywords: ['thinking', 'reasoning', 'variant'],
  },
  {
    id: 'sessions.default-agent',
    page: 'sessions',
    titleKey: 'settings.pichamber.defaults.field.defaultAgent',
    keywords: ['agent', 'new sessions'],
  },
  {
    id: 'sessions.deletion-dialog',
    page: 'sessions',
    titleKey: 'settings.pichamber.defaults.field.showDeletionDialog',
    keywords: ['delete', 'confirmation'],
  },
  {
    id: 'sessions.small-model',
    page: 'sessions',
    titleKey: 'settings.pichamber.defaults.smallModel.title',
    descriptionKey: 'settings.pichamber.defaults.smallModel.description',
    keywords: ['small model', 'utility', 'summary', 'recap', 'cheap', 'override'],
  },
  {
    id: 'sessions.walkthrough-model',
    page: 'sessions',
    titleKey: 'settings.pichamber.defaults.walkthroughModel.title',
    descriptionKey: 'settings.pichamber.defaults.walkthroughModel.description',
    keywords: ['walkthrough', 'diff', 'review', 'changes', 'structured output', 'model', 'override'],
  },
  {
    id: 'sessions.auto-cleanup',
    page: 'sessions',
    titleKey: 'settings.pichamber.sessionRetention.field.enableAutoCleanup',
    descriptionKey: 'settings.pichamber.sessionRetention.tooltip',
    keywords: ['retention', 'archive', 'delete'],
  },
  {
    id: 'sessions.retention-period',
    page: 'sessions',
    titleKey: 'settings.pichamber.sessionRetention.field.retentionPeriod',
    keywords: ['days', 'cleanup', 'retention'],
  },
  {
    id: 'sessions.retention-action',
    page: 'sessions',
    titleKey: 'settings.pichamber.sessionRetention.field.whenSessionsExpire',
    keywords: ['archive', 'delete', 'expire'],
  },
  {
    id: 'sessions.desktop-launch-at-login',
    page: 'general',
    titleKey: 'settings.pichamber.desktopNetwork.field.launchAtLogin',
    descriptionKey: 'settings.pichamber.desktopNetwork.field.launchAtLoginDescription',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.pichamber.desktopNetwork.field.windowControlsPosition',
    descriptionKey: 'settings.pichamber.desktopNetwork.field.windowControlsPositionDescription',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.pichamber.desktopNetwork.field.windowControlsStyle',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.pichamber.desktopNetwork.field.macMenuBar',
    descriptionKey: 'settings.pichamber.desktopNetwork.field.macMenuBarDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.pichamber.desktopNetwork.field.minimizeToTray',
    descriptionKey: 'settings.pichamber.desktopNetwork.field.minimizeToTrayDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.pichamber.desktopNetwork.field.keepAwake',
    descriptionKey: 'settings.pichamber.desktopNetwork.field.keepAwakeDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.pichamber.desktopPassword.field.password',
    descriptionKey: 'settings.pichamber.desktopPassword.field.passwordDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.pichamber.desktopNetwork.field.allowLanAccess',
    descriptionKey: 'settings.pichamber.desktopNetwork.field.allowLanAccessDescription',
  ...
  },
  {
    id: 'git.changes-view',
    page: 'git',
    titleKey: 'settings.pichamber.git.changesViewTitle',
    keywords: ['changes', 'flat list', 'tree view'],
  },
  {
    id: 'git.gitmoji',
    page: 'git',
    titleKey: 'settings.pichamber.git.enableGitmoji',
    keywords: ['commit', 'emoji'],
  },
  {
    id: 'git.gitignored-files',
    page: 'git',
    titleKey: 'settings.pichamber.git.showGitignored',
  ...
  },
  {
    ...
    page: 'projects',
    titleKey: 'settings.pichamber.worktrees.setup.waitForCommands',
  ...
  },
  {
    ...
    page: 'shortcuts',
    titleKey: 'settings.pichamber.keyboardShortcuts.title',
    descriptionKey: 'settings.pichamber.keyboardShortcuts.tooltip',
