 ...
 * it as `window.__PICHAMBER_DESKTOP_BOOT_OUTCOME__`. This module provides
...
export function getInjectedBootOutcome(): DesktopBootOutcome | null {
  ...
  const raw = (window as { __PICHAMBER_DESKTOP_BOOT_OUTCOME__?: unknown })
    .__PICHAMBER_DESKTOP_BOOT_OUTCOME__;
