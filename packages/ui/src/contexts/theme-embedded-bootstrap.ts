...
type ThemeBootstrapWindow = Window & {
  __pichamberEmbeddedThemeBootstrap?: unknown;
};
...
export const publishEmbeddedThemeBootstrap = (theme: Theme): void => {
  ...
  (window as ThemeBootstrapWindow).__pichamberEmbeddedThemeBootstrap = theme;
};
...
export const readEmbeddedThemeBootstrap = (): Theme | null => {
  ...
  try {
    ...
    return isValidTheme(parent.__pichamberEmbeddedThemeBootstrap)
      ? parent.__pichamberEmbeddedThemeBootstrap
      : null;
  } catch {
    return null;
  }
