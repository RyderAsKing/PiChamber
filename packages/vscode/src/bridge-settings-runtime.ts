...
const OPENCHAMBER_SHARED_SETTINGS_PATH = resolvePiChamberDataPath('settings.json');
const OPENCHAMBER_MAGIC_PROMPTS_PATH = resolvePiChamberDataPath('magic-prompts.json');
