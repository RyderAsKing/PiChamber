 ...
 *   events race.
 * - An `AbortSignal` is handed to `subscribe` for subscribers that support
 *   cancellation; subscribers that do not (the current IPC client) are still
 *   torn down through the returned close function.
