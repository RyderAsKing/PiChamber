...
- Use um [túnel](/pt-br/tunnels/) quando você precisar de uma **URL pública** comum — por exemplo, para abrir o PiChamber em um navegador qualquer numa máquina que você não pode parear, ou para compartilhar o acesso protegido por uma [senha de UI](/pt-br/security/).
