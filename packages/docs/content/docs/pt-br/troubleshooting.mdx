...
## O comando PiChamber encerra ou não inicia

- confirme o Node.js `>=22`
- execute `pichamber --version`
- reinstale a CLI mais recente se necessário

## A UI web não está acessível

- verifique os logs do servidor com `pichamber logs`
...
- confirme que o servidor do PiChamber está em execução
