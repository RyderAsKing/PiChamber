...
## Polecenie PiChamber kończy się lub nie uruchamia

- upewnij się, że Node.js `>=22`
- uruchom `pichamber --version`
- w razie potrzeby zainstaluj ponownie najnowsze CLI

## Webowy interfejs jest nieosiągalny

- sprawdź logi serwera poleceniem `pichamber logs`
...
- upewnij się, że serwer PiChamber działa
