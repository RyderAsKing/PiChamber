...
## El comando PiChamber se cierra o no arranca

- confirma que Node.js es `>=22`
- ejecuta `pichamber --version`
- reinstala la última CLI si hace falta

## No se puede acceder a la UI web

- revisa los logs del servidor con `pichamber logs`
...
- confirma que el servidor de PiChamber está en marcha
