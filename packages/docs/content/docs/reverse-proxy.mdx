---
title: Reverse Proxy
description: Configure PiChamber correctly behind Nginx, Nginx Proxy Manager, or another reverse proxy.
---

# Reverse Proxy

Use this page if you run PiChamber behind Nginx, Nginx Proxy Manager, Caddy, Cloudflare, or another reverse proxy.
