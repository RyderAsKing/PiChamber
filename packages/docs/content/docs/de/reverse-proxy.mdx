---
title: Reverse Proxy
description: Konfigurieren Sie PiChamber korrekt hinter Nginx, Nginx Proxy Manager oder einem anderen Reverse Proxy.
---

# Reverse Proxy

Nutzen Sie diese Seite, wenn PiChamber hinter Nginx, Nginx Proxy Manager, Caddy, Cloudflare oder einem anderen Reverse Proxy läuft.

## Bevor Sie es proxyen

1. Bestätigen Sie zuerst, dass PiChamber direkt funktioniert.
...
- Deaktivieren Sie gzip auf dem Proxy, wenn PiChamber Antworten bereits komprimiert.
...
- PiChamber direkt im LAN erreichbar
...
- PiChamber komprimiert HTTP-Antworten mit gzip (Schwelle 1 KB).
...
SSE-Streaming-Routen sind von PiChamber von der Komprimierung ausgeschlossen, das CDN kann sie aber trotzdem puffern. Prüfen Sie in der CDN-Dokumentation, wie sich Buffering auf SSE-Pfaden deaktivieren lässt.
