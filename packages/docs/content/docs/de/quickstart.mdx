---
title: Schnellstart
description: Starte PiChamber schnell und wähle die richtige App für die Aufgabe.
---
...
2. Installiere das PiChamber-CLI (siehe [Installieren](/install/) für den Einzeilenbefehl).
3. Führe `pichamber --ui-password be-creative-here` aus.
...
Du solltest die PiChamber-Session-Liste in deinem Browser sehen. Wenn sie geladen wird, bist du startklar.
