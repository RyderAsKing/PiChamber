...
Die Desktop-App kann unter **Settings → PiChamber → Tunnel** einen öffentlichen Tunnel erstellen. Für diesen Weg musst du PiChamber nicht per CLI starten.

## Anbieter installieren

PiChamber startet das Provider-CLI auf deinem Rechner. Installiere zuerst den Anbieter, den du verwenden möchtest:
...
1. Öffne **Settings → PiChamber → Tunnel**.
