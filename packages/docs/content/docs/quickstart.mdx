---
title: Quickstart
description: Start PiChamber quickly and pick the right app for the task.
---
...
2. Install the PiChamber CLI (see [Install](/install/) for the one-line command).
...
You should see the PiChamber session list in your browser. If it loads, you're up and running.
