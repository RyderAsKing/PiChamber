...
description: Install the PiChamber app on iOS or Android and connect it to your server.
---

# Mobile Apps & PWA

PiChamber has native apps for iPhone and Android, so you can watch sessions, reply to agents, and manage work from your phone — at home over Wi-Fi or from anywhere over the [Private Relay](/private-relay/).

## Install the app

- **iPhone/iPad** — join the [TestFlight beta](https://testflight.apple.com/join/5ek6GU1E)
- **Android** — download the APK from the [latest release](https://github.com/RyderAsKing/PiChamber/releases/latest)

## Connect it to your server

1. On the computer running PiChamber, open **Settings → Remote Instances → Connect to this server** and press **Add a device**.
...
Under **Settings → PiChamber**, a few options tune the mobile and installed experience — the app's installed name, screen orientation, and how the on-screen keyboard behaves.
