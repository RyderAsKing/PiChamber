...
Start PiChamber locally, then run:
...
measure, then return to the terminal and press Enter. Use PiChamber normally
...
bun run profile:browser -- --output /tmp/pichamber-profile
