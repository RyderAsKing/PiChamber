...
const uiPort = process.env.PICHAMBER_HMR_UI_PORT || '5180';
const backendPort = process.env.PICHAMBER_HMR_API_PORT || '3902';
const hmrHost = process.env.PICHAMBER_HMR_HOST || '127.0.0.1';
