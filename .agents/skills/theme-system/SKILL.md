---
name: theme-system
description: Use when creating or modifying PiChamber UI components, styling, colors, buttons, visual states, themes, or icons.
---
...
- Use semantic PiChamber theme tokens; never hardcode hex colors or generic Tailwind palette colors.
